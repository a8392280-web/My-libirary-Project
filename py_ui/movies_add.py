...
################################################################################
## Form generated from reading UI file 'movies_addpcLWJl.ui'
##
...
"")
        ...
        self.manual_user_rate_input = QLineEdit(self.layoutWidget1)
        self.manual_user_rate_input.setObjectName(u"manual_user_rate_input")
        self.manual_user_rate_input.setStyleSheet(u"QLineEdit {\n"
"    color: rgb(0, 0, 0);\n"
"    font-size: 14px;\n"
"    background-color: transparent;\n"
"    padding: 6px;\n"
